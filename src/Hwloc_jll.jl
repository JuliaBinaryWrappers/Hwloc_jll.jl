...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Hwloc_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("e33a78d0-f292-5ffc-b300-72abe9b543c8"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Hwloc", artifacts_toml) for e in artifacts["Hwloc"]]
...
if best_platform === nothing
    @debug("Unable to load Hwloc; unsupported platform $(triplet(platform_key_abi()))")
else
