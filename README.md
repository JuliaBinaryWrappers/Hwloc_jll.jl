# `Hwloc_jll.jl` (v2.14.0+0)

[![deps](https://juliahub.com/docs/Hwloc_jll/deps.svg)](https://juliahub.com/ui/Packages/General/Hwloc_jll/)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/b6f83d2b857f030664ed1e42ecb91f557a66a8db/H/Hwloc/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* compressed archive: https://download.open-mpi.org/release/hwloc/v2.14/hwloc-2.14.0.tar.bz2 (SHA256 checksum: `966b9bb3e9f29f8d65ce8d106779e457f40e246a645e584b100772a42f9ae94b`)
